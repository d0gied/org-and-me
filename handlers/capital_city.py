...
async def area_planing(callback_query: types.CallbackQuery):
    ...
    await message.edit_caption(
        caption=texts.CAPITAL_AREA_PLANING, reply_markup=keyboards.to_capital_city
    )
...
async def culture(callback_query: types.CallbackQuery):
    message = callback_query.message
    await message.edit_caption(
        caption=texts.CAPITAL_CULTURE, reply_markup=keyboards.to_capital_city
    )
...
async def economy(callback_query: types.CallbackQuery):
    message = callback_query.message
    await message.edit_caption(
        caption=texts.CAPITAL_ECONOMY, reply_markup=keyboards.to_capital_city
    )
...
async def social_policy(callback_query: types.CallbackQuery):
    message = callback_query.message
    await message.edit_caption(
        caption=texts.CAPITAL_SOCIAL_POLICY, reply_markup=keyboards.to_capital_city
    )
